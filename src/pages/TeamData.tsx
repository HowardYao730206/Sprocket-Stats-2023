...
function TeamData(props) {
  ...
  function getTeam() {
    ...
    axios
      .get(
        `https://backend2022-ss-production.up.railway.app/api/v1/datasets/datasetId/63cca5c693416092590040f8/teamNumber/${teamNumber}`,
        config
      )
      .then((res) => {
        pitEntry = res.data;
    ...
    axios
      .get(
        `https://backend2022-ss-production.up.railway.app/api/v1/datasets/datasetId/63cca5ef93416092590040f9/teamNumber/${teamNumber}`,
        config
      )
      .then((res) => {
        console.log(res.data);
