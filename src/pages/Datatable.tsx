...
function DataTable(props) {
  ...
  function getColumns() {
    ...
    axios
      .get(
        ...
        `https://backend2022-ss-production.up.railway.app/api/v1/templates/templateId/${props.match.params.templateId}`,
        config
      )
      .then((res) => {
  ...
  function getData() {
    ...
    axios
      .get(
        `https://backend2022-ss-production.up.railway.app/api/v1/datasets/datasetId/${props.match.params.datasetId}/viewData`,
        config
      )
      .then((res) => {
        entries = res.data;
