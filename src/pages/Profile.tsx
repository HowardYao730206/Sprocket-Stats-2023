import { Button, Avatar, Grid, TextField, Typography } from "@mui/material";
...
function Profile() {
  ...
  function onPageLoad() {
    ...
    axios
      .get(
        "https://backend2022-ss-production.up.railway.app/api/v1/events/eventId/" +
  ...
  function onSubmit() {
    ...
    axios
      .patch(
        "https://backend2022-ss-production.up.railway.app/api/v1/users/currentEvent",
        { eventCode: enterCode },
        config
      )
      .then((res) => {
